...
@php
    ...
    $limit = json_decode(appsetting('USER_INACTIVE_LIMIT'));
        ...
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
            ...
            <p style="margin-top: 5px;margin-bottom: 0; font-size: 12px;font-family: Ubuntu,sans-serif;">
                <p style="margin: 0; font-size: 12px; font-family: Ubuntu,sans-serif;">
                    Your Account is suspend because you not active for {{$limit}} Day's. Click the link below to change your password.
                </p>
